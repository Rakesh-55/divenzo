    ...
    <div className="font-nav">
            ...
            <div className="hidden lg:flex gap-12">
              {navLinks.map(link => (
                <Link
                  ...
                  to={link.page}
                  className={`
                    relative text-[12px] font-medium tracking-wide
      ...
      {showBurger && (
        <button
          ...
          className={`
            fixed top-6 right-8 z-[200] w-12 h-12 rounded-full
        ...
        >
          <div className="relative w-6 h-6">
            <span
              className={`
                absolute left-0 top-2 h-[2px] w-full transition-all
                ${menuOpen ? "rotate-45 top-3 bg-white" : onDarkSection ? "bg-white" : "bg-black"}
              `}
            />
            <span
              className={`
                absolute left-0 top-4 h-[2px] w-full transition-all
                ${menuOpen ? "-rotate-45 top-3 bg-white" : onDarkSection ? "bg-white" : "bg-black"}
              `}
            />
          </div>
