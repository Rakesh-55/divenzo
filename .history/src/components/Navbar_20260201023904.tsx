  ...
  return (
    <div className="font-nav">
      ...
      <header className="lg:hidden fixed top-0 left-0 w-full z-[500]">
        <nav 
          className={`flex items-center justify-between px-6 py-4 transition-all duration-500 ${scrolled && !menuOpen && onDarkSection ? "backdrop-blur-2xl" : ""}`}
          style={{
      ...
      <header className={`fixed top-0 left-0 w-full z-[100] transition-all duration-500 ${menuOpen ? "z-[400]" : ""}`}>
        <nav
          className={`
            ...
            ${scrolled && !menuOpen && onDarkSection ? "backdrop-blur-2xl" : ""}
          `}
          style={{
            backgroundColor: 
              menuOpen
