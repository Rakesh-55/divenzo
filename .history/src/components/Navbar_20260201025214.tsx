...
export const Navbar = (): JSX.Element => {
  ...
  return (
    <div className="font-nav">
      {/* ================= MOBILE HEADER ================= */}
      <header data-site-header className="lg:hidden fixed top-0 left-0 w-full z-[500]">
        <nav 
      ...
      {/* ================= DESKTOP HEADER ================= */}
      <header data-site-header className={`fixed top-0 left-0 w-full z-[100] transition-all duration-500 ${menuOpen ? "z-[400]" : ""}`}>
        <nav
          className={`
            hidden lg:grid
