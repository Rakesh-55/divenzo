...
export default function About() {
  ...
  useEffect(() => {
    ...
    i === 0
      ? `<span class='word inline-block text-current overflow-hidden'>${word}</span>`
  ...
  return (
    <>
      ...
      <section id="about-us-section" className="relative w-full  overflow-x-hidden">
        <div className="max-w-[1280px] mx-auto pt-6 md:pt-10 pb-10 md:pb-20 px-4 lg:px-0">

          {/* ABOUT */}
          <h2 className="[font-family:'Poppins',Helvetica] font-semibold text-current text-[56px] sm:text-[80px] lg:text-[120px] leading-[1] mb-[36px] md:mb-[56px]">
            About Us
          </h2>

          <div className="ml-0 lg:ml-[350px]">
            <p className="[font-family:'Poppins',Helvetica] font-normal text-current text-[18px] sm:text-[24px] lg:text-[40px] mb-[36px] md:mb-[56px]">
          ...
          <div className="ml-0 lg:ml-[350px] space-y-[16px] md:space-y-[56px]">
            <p className="[font-family:'Poppins',Helvetica] font-normal text-current text-[18px] sm:text-[24px] lg:text-[40px]">
          ...
          <div className="mt-[40px] md:mt-[100px]">
            <h3
              ref={headingRef}
              className="
              [font-family:'Poppins',Helvetica] font-normal text-current
              ...
              {statsData.map((stat, i) => (
                <Card key={i} className="border-0 shadow-none bg-transparent stat-card" >
                  <CardContent className="p-0 flex flex-col md:gap-4">
                    <div className="[font-family:'Poppins',Helvetica] font-semibold text-current text-[48px] sm:text-[56px] lg:text-7xl">
                      {stat.number}
                    </div>
