...
export default function About() {
  ...
  useEffect(() => {
    ...
    if (section1) {
      // start black
      gsap.set(section1, { backgroundColor: "#000", color: "#fff" });
    ...
    if (section2) {
      gsap.set(section2, { backgroundColor: "#000", color: "#fff" });
  ...
  return (
    <>
      <Navbar />
      <div id="about-page-wrapper"></div>
      <section id="about-section-1" className="relative w-full  overflow-x-hidden">
