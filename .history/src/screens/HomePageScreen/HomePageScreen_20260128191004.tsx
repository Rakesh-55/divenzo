  ...
  return (
    <div>
      ...
      <div ref={footerWrapperRef} className="relative">
        ...
        {/* Footer - Positioned at the bottom, stays in place */}
        <div className="relative">
          <FooterSection />
        </div>

        {/* Main Content - This is the curtain that moves up to reveal footer */}
        <main
          ref={curtainRef}
          className="absolute top-0 left-0 w-full z-10 bg-white dark:bg-gray-900 will-change-transform"
        >
          <HeroSection />
          <AboutSection />
          <ProjectsSection />
