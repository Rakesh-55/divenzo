...
export const TestimonialsSection = (): JSX.Element => {
  ...
  return (
    <section className="relative w-full bg-black overflow-x-hidden">
      <div className="container mx-auto bg-white py-[100px] sm:py-[140px] lg:py-[160px]">
        <div className="flex flex-col gap-10 md:gap-20 px-4 sm:px-6 lg:px-8">
