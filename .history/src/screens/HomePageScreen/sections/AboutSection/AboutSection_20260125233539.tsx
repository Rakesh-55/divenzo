        ...
        <div className="mb-[56px]">
          ...
          >
            ...
            <Link to="/about">
              <Button
                variant="link"
                className="h-auto p-0 flex flex-col items-start gap-0.5"
              >
                <span
                  className="
                    [font-family:'Poppins',Helvetica] font-normal text-black
                ...
                <div className="w-[160px] sm:w-[190px] lg:w-[226px] h-0.5 bg-[#00000066]" />
              </Button>
            </Link>
          </div>
        </div>
              ...
              >
                <CardContent className="p-0 flex flex-col gap-4">
                  ...
                  <div className="flex flex-col gap-[10px]">
                    <h4
                      className="
                        [font-family:'Poppins',Helvetica] font-bold text-black
                    ...
                    <p
                      className="
                        [font-family:'Poppins',Helvetica] font-normal text-[#000000cc]
