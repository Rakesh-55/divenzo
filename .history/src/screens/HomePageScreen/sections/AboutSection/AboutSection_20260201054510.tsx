...
export const AboutSection = (): JSX.Element => {
  // const headingRef = useRef<HTMLHeadingElement | null>(null); // Moved to AnimatedText component
  ...
  useEffect(() => {
    // Heading animation now handled by AnimatedText component
    // if (!headingRef.current) return;

    const el = null; // headingRef.current - removed
    const fullText =
