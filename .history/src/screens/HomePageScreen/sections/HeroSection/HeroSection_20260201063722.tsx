      ...
      >
        ...
        <AnimatedText
          className="
            ...
            leading-[1.4]
            w-full lg:w-[932px]
            relative z-[1] transition-all duration-700 hidden md:block
          "
          isDarkBg={false}
        >
          Digital design isn&apos;t static — it&apos;s alive. Brands today need movement, meaning, and emotion. We blend strategy, creativity, and storytelling to craft experiences that capture attention, spark action, and leave a lasting impression.
        </AnimatedText>
