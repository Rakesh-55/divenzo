        ...
        >
          {socialLinks.map((link, index) => (
            <Button
              ...
              "
            >
              <span className="relative block leading-none transition-transform duration-300 group-hover:scale-105">
              ...
              <Link to="/discuss">
                <Button
                  ...
                  className="
                    ...
                    rounded-none footer-no-underline overflow-hidden group
                    [font-family:'Poppins',Helvetica] font-normal text-white
              ...
              {contactInfo.map((info, index) => (
                <a
                  ...
                  className="
                    [font-family:'Poppins',Helvetica] font-normal text-white
                    text-[16px] sm:text-[18px] lg:text-2xl
                    no-underline footer-no-underline overflow-hidden group
                  "
                >
                  <span className="relative inline-block leading-none transition-transform duration-300 group-hover:scale-105">
                    <span className="block transition-transform duration-500 ease-out group-hover:-translate-y-full">
                      {info.text}
                    </span>
                    <span className="absolute left-0 top-0 translate-y-full transition-transform duration-500 ease-out group-hover:translate-y-0">
