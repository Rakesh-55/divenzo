...
export const FooterSection = (): JSX.Element => {
  ...
  useEffect(() => {
    if (!companyRef.current || !footerRef.current) return;
    ...
    gsap.fromTo(
      ...
      },
      {
        ...
        stagger: {
          each: 0.06,
          from: "start", // first letter first (both directions)
        },
        scrollTrigger: {
          trigger: footerRef.current, // 👈 IMPORTANT
          start: "top bottom",
          end: "bottom bottom",
          scrub: 3, // 👈 smoother near page end
        },
      }
    );
  }, []);
...
useEffect(() => {
  ...
  },
  {
    yPercent: 0,
    opacity: 1,
    ease: "power2.out", // 👈 slows near the end
    stagger: {
      each: 0.06,
      from: "start",
    },
