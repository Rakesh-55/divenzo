        ...
        >
          {socialLinks.map((link, index) => (
            <Button
              ...
              "
            >
              <span className="hover-slide-vertical">
                <span className="hover-slide-vertical__text">{link.name}</span>
                <span className="hover-slide-vertical__text hover-slide-vertical__text--hover">
                  {link.name}
                </span>
              </span>
            </Button>
          ...
          >
            ...
            >
              ...
              <Link to="/discuss">
                ...
                >
                  <span className="hover-slide-vertical">
                    <span className="hover-slide-vertical__text">Discuss with us</span>
                    <span className="hover-slide-vertical__text hover-slide-vertical__text--hover">
                      Discuss with us
                    </span>
                  </span>
            ...
            >
              {contactInfo.map((info, index) => (
                ...
                >
                  <span className="hover-slide-vertical">
                    <span className="hover-slide-vertical__text">{info.text}</span>
                    <span className="hover-slide-vertical__text hover-slide-vertical__text--hover">
                      {info.text}
                    </span>
                  </span>
