  ...
  useEffect(() => {
    ...
    gsap.fromTo(
      ...
      },
      {
        y: 0,
        opacity: 1,
        ease: "none", // IMPORTANT: no easing fights scroll
        stagger: {
          each: 0.06,
          from: "start", // first letter moves first
        },
        scrollTrigger: {
          trigger: companyRef.current,
          start: "top 85%",
          end: "top 40%",
          scrub: 1.8, // 👈 smooths glitches
        },
      }
  );
          ...
          {socialLinks.map((link, index) => (
            ...
            >
              <span className="relative block leading-none">
                <span className="block transition-transform duration-500 ease-out group-hover:-translate-y-full group-hover:scale-105">
                  {link.name}
                </span>
                <span className="absolute left-0 top-0 translate-y-full transition-transform duration-500 ease-out group-hover:translate-y-0 group-hover:scale-105">
                  {link.name}
                </span>
              </span>
            </Button>
              ...
              <Link to="/discuss">
                <Button
                  ...
                  className="
                    ...
                    rounded-none footer-no-underline 
                    [font-family:'Poppins',Helvetica] font-normal text-white
                  ...
                  <React.Fragment key={index}>
                    ...
                    <Link to={link.page}>
                      <Button
                        variant="link"
                        className="
                          h-auto p-0 footer-no-underline
                          hover:bg-transparent focus:bg-transparent active:bg-transparent
