...
export const FooterSection = (): JSX.Element => {
  ...
  const pinnedFooterRef = useRef<HTMLElement>(null);


  useEffect(() => {
    if (!pinnedFooterRef.current) return;

    ScrollTrigger.create({
      trigger: pinnedFooterRef.current,
      start: "top bottom",
      end: "+=120vh",
      pin: true,
      pinSpacing: false,
  ...
  gsap.fromTo(
    ...
    },
    {
      ...
      stagger: {
        each: 0.08,
        from: "start", // FIRST letter first (important)
      },
      scrollTrigger: {
        trigger: footerRef.current,
        start: "top 70%",
        end: "top 20%",
        scrub: 2.2, // smoother like the clip
      },
    }
  );
}, []);
  ...
  return (
    ...
    {/* FOOTER (stays still) */}
    <footer ref={pinnedFooterRef}
      className="
        relative bottom-0 w-full bg-black dark-section
