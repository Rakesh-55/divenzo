...
export const FooterSection = (): JSX.Element => {
  ...
  useEffect(() => {
    ...
    const handleScroll = () => {
      ...
      // Trigger animation only when scrolling UP and logo is in viewport
      if (isScrollingUp && !isAnimatingRef.current) {
        ...
        if (isInViewport) {
          ...
          // Letter-by-letter slide-up reveal - smooth, staggered
          tl = gsap.timeline();
          tl.fromTo(
            letters,
            {
