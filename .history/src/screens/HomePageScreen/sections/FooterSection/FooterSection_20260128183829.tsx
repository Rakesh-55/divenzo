...
export const FooterSection = () => {
  ...
  useEffect(() => {
    ...
    // Fade/slide in navigation links
    if (navRef.current) {
  ...
  return (
    <section className="relative w-full">
      ...
      {/* Sticky footer */}
      <footer className="sticky bottom-0 w-full bg-black text-white px-8 py-16">
