...
export const FooterSection = (): JSX.Element => {
  ...
  useEffect(() => {
    ...
    // Smooth, immediate, continuous scroll-linked animation
    gsap.fromTo(
      letters,
      {
        y: 100,
      ...
      },
      {
        y: 0,
        opacity: 1,
        ease: "power1.inOut", // Smooth easing, no jitter
        stagger: {
          each: 0.1,
          from: "start",
        },
        scrollTrigger: {
          ...
          start: "top 90%", // Trigger immediately when element nears viewport
          end: "top 35%", // Extended range for smooth continuous motion
          scrub: 1.5, // Fast scrub for instant responsiveness
