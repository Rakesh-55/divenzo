...
export const FooterSection = (): JSX.Element => {
  ...
  useEffect(() => {
    ...
    if (curtainRef.current && footerRef.current) {
  ...
  return (
    <section ref={footerRef} className="relative w-full h-screen">
      {/* CURTAIN - The section above that lifts up */}
      <div
        ref={curtainRef}
        className="
        ...
        "
      >
        {/* You can put your above section content here, or leave it empty if it's a separate component */}
      ...
      {/* FOOTER - Stays fixed, revealed by curtain */}
      <footer
        className="
            ...
            >
              ...
              >
                <p
                  ...
                  "
                >
                  Copyright © {new Date().getFullYear()} Divenzo. All rights
                  reserved
                </p>
