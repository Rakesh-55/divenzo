...
export const FooterSection = (): JSX.Element => {
  ...
  useEffect(() => {
    // Pin the footer while scrolling to create reveal effect
    if (wrapperRef.current && footerRef.current) {
  ...
  return (
    <div ref={wrapperRef} className="relative w-full" style={{ height: '100vh' }}>
      {/* FOOTER (pinned and revealed as you scroll) */}
      <footer
        ref={footerRef}
        className="
          w-full h-screen bg-black dark-section
          flex items-center justify-center
          px-4 sm:px-8 lg:px-20
          overflow-y-auto
        "
      >
        <div className="w-full py-[80px] sm:py-[120px] lg:py-[150px]">
