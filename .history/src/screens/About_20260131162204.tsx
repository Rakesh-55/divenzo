...
export default function About() {
  ...
  useEffect(() => {
  const wrapper = document.getElementById("about-page-wrapper");
  const trigger = document.getElementById("about-color-trigger");
    ...
    <>
      ...
      <section  className="relative w-full  overflow-x-hidden">
        <div className="max-w-[1280px] mx-auto py-10 md:py-20 px-4 lg:px-0">
          ...
          {/* ABOUT */}
          <h2 className="[font-family:'Poppins',Helvetica] font-semibold  text-[56px] sm:text-[80px] lg:text-[120px] leading-[1] mb-[36px] md:mb-[56px]">
            About Us
          </h2>

          <div className="ml-0 lg:ml-[350px]">
            <p className="[font-family:'Poppins',Helvetica] font-normal  text-[18px] sm:text-[24px] lg:text-[40px] mb-[36px] md:mb-[56px]">
          ...
          <div className="ml-0 lg:ml-[350px] space-y-[16px] md:space-y-[56px]">
            <p className="[font-family:'Poppins',Helvetica] font-normal  text-[18px] sm:text-[24px] lg:text-[40px]">
              ...
              {statsData.map((stat, i) => (
                <Card key={i} className="border-0 shadow-none bg-transparent stat-card" >
                  <CardContent className="p-0 flex flex-col md:gap-4">
                    <div className="[font-family:'Poppins',Helvetica] font-semibold  text-[48px] sm:text-[56px] lg:text-7xl">
                      {stat.number}
                    </div>
        ...
        {/* ================= TEAM SECTION ================= */}
        <div id="about-color-trigger" className="h-[1px]" />
