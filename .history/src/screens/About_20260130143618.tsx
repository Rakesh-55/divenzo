        ...
        <div className="max-w-[1280px] mx-auto py-10 md:py-20 px-4 lg:px-0">
          ...
          <div className="ml-0 lg:ml-[350px]">
            <p className="[font-family:'Poppins',Helvetica] font-normal text-black text-[18px] sm:text-[24px] lg:text-[40px] mb-[36px] md:mb-[56px]">
              As123 global leaders in UX/UI design, technology and marketing solutions, we are dedicated to simplifying, strengthening, and transforming businesses of all sizes. our mission is to bridge the gap between creativity and technology, crafting seamless experiences that inspire users and drive measurable outcomes for our clients.
            </p>
          </div>
