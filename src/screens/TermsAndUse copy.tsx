...
//               <h2 className="[font-family:'Poppins',Helvetica] font-semibold text-black text-[120px] tracking-[0] leading-[110px] mb-[56px]">
//                 Terms <br /> &amp; use
//               </h2>

//               <div className=" ml-[350px]">
//                 <p className="[font-family:'Poppins',Helvetica] font-normal text-black text-[24px] tracking-[0] leading-[normal] mb-[26px]">
//                   The These Terms of Use (“Terms of Use”) have been drafted in accordance with the provisions of Rule 3 (1) of the Information Technology (Intermediaries guidelines) Rules, 2011 that require publishing the rules and regulations, privacy policy and Terms of Use for access or usage of https://divenzo.com/.
//                 </p>

//               </div>
//             </div>

//             <div className="my-8 ml-[350px]">
//                   {termsAndUse.map((section) => (
//                     <div key={section.id} className="flex flex-col mb-10">
//                       {/* Title */}
//                       <h2 className="[font-family:'Poppins',Helvetica] font-semibold text-black text-[32px]  leading-[1.3] mb-4">
//                         {section.title}
//                       </h2>

//                       <p className="[font-family:'Poppins',Helvetica] font-normal text-[#000000cc] text-[20px] md:text-[22px] leading-[1.6]">
//                         {section.desc}
//                       </p>
//                     </div>
//                   ))}
...
//                       <ul className="list-disc pl-6 mt-2 grid grid-cols-1 gap-2">
//                         {section.points.map((point, index) => (
//                           <li
//                             key={index}
//                             className="[font-family:'Poppins',Helvetica] font-normal text-[#000000cc] text-[20px] md:text-[22px] leading-[1.6] mb-2"
//                           >
//                             {point}
//                           </li>
//                         ))}
    ...
    <>
      ...
      <section className="relative w-full bg-white">
        <div className="flex h-[100vh] overflow-hidden">
          ...
          <div
            ref={headingRef}
            className="w-[40%] flex flex-col items-start justify-start bg-white pt-20 pl-20 "
          >
            <h2 className="[font-family:'Poppins',Helvetica] font-semibold text-black text-[120px] tracking-[0] leading-[95px] text-start">
              Terms
            </h2>
            <h2 className="[font-family:'Poppins',Helvetica] font-semibold text-black text-[120px] tracking-[0] leading-[95px] text-start">
              &amp; Use
          ...
          <div className="w-[60%] overflow-y-scroll no-scrollbar">
            <div className="px-[100px] py-20">
              <p className="[font-family:'Poppins',Helvetica] font-normal text-black text-[24px] leading-[1.6] mb-[26px]">
              ...
              <div className="mb-10">
                {termsAndUseData.map((section) => (
                  <div key={section.id} className="flex flex-col mb-10">
                    ...
                    <p className="[font-family:'Poppins',Helvetica] font-normal text-[#000000cc] text-[20px] md:text-[22px] leading-[1.6] mb-4">
                      {section.description}
                    </p>
                    ...
                    <ul className="list-disc pl-6 grid gap-2">
                      {section.points.map((point, index) => (
                        <li
                          key={index}
                          className="[font-family:'Poppins',Helvetica] font-normal text-[#000000cc] text-[20px] md:text-[22px] leading-[1.6]"
                        >
                          {point}
                        </li>
                      ))}
